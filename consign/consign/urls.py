...
urlpatterns = [
    ...
    path('fullLoadprint/<int:pk>/', views.fullLoadprint, name='fullLoadprint'),
    path('invoice/<str:sender_name>/', views.generate_invoice, name='generate_invoice'),
    path('vehiclePayment',views.vehiclePayment,name='vehiclePayment'),
    path('get-vehicle-data/', views.get_vehicle_data, name='get_vehicle_data'),
    path('save_vehicle_payment/', views.save_vehicle_payment, name='save_vehicle_payment'),

    path('vehiclePayReport',views.vehiclePayReport,name='vehiclePayReport'),
    path('get-vehicle-payments/',views.get_vehicle_payments,name='get_vehicle_payments'),

    path('vehiclepayment/summary/', views.vehiclepayment_summary, name='vehiclepayment_summary'),
    path('vehiclepayment/details/<int:load_id>/', views.fetch_vehiclepayment_details, name='vehiclepayment_details'),

    path('vehiclepayment/edit/<int:id>/', views.edit_vehiclepayment, name='edit_vehiclepayment'),

    path('daily_consignment', views.daily_consignment, name='daily_consignment'),
    path('adminprintConsignment/<int:track_id>/', views.adminprintConsignment, name='adminprintConsignment'),
    path('adminviewconsignment',views.adminviewconsignment,name='adminviewconsignment'),

    path('adminconsignment_edit/<int:pk>', views.adminconsignment_edit, name='adminconsignment_edit'),


    path('booking',views.booking,name='booking'),
    path('booking_list',views.booking_list,name='booking_list'),
    path('edit_booking/<int:id>', views.edit_booking, name='edit_booking'),
    path('booking_report/<int:booking_id>/', views.booking_report, name='booking_report'),
    path('booking_balance', views.booking_balance, name='booking_balance'),
    ...
    path('quotation/<int:quot_id>/', views.quotation, name='quotation'),
